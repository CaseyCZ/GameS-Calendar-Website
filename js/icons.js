...
const ICONS = Object.freeze({
  ...
  epic: `<svg ${COMMON}><path d="M6.5 4.5h11l-1.1 13.2L12 20l-4.4-2.3L6.5 4.5Z" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M9.2 8h5.6M9.5 11h5M9.8 14h4.4" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
